...
<head>
    ...
    <title>Page Not Found - Masatrek</title>
    ...
    <link rel="stylesheet" href="assets/css/Masatrek.css">
</head>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link" href="attendance_management.html"><i class="fa fa-table"></i><span>Attendance Management</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="visitor_management.html"><i class="fa fa-users"></i><span>Visitor Management</span></a></li>
                    <li class="nav-item"><a class="nav-link" href="device_management.html"><i class="fa fa-desktop"></i><span>Device Management</span></a></li>
